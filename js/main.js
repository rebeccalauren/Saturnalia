...
// 	$(leftHeight).css("height", rightHeight + "px");
// }
// else {
// 	$(rightHeight).css("height", leftHeight + "px");
// }

// if (rightHeight2 > leftHeight2) {
// 	$(leftHeight2).css("height", rightHeight2 + "px");
// }
// else {
// 	$(rightHeight2).css("height", leftHeight2 + "px");
// }

// if (rightHeight3 > leftHeight3) {
// 	$(leftHeight3).css("height", rightHeight3 + "px");
// }
// else {
// 	$(rightHeight3).css("height", leftHeight3 + "px");
// }
// });
